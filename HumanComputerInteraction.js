...
function ExplainCorrect1() {
    document.getElementById("Explain01").innerHTML = "You are Correct! \n C. Application Software are a group of programs that run on electronic devices. These programs are designed for the user to carry out different tasks.";
...
function ExplainCorrect2() {
    document.getElementById("Explain02").innerHTML = "You are Correct! B. Address a place where a person or organization may be communicated with.";
...
function ExplainCorrect3() {
    document.getElementById("Explain03").innerHTML = "You are Correct! \n C. Python is often used as a support language for software developers, for build control and management, testing, and in many other ways.";
...
function ExplainWrong5() {
    document.getElementById("Explain05").innerHTML = "Wrong Answer\n The Correct is\n D. Facebook is developed by Mark Elliot Zuckerberg.";
...
function ExplainCorrect5() {
    document.getElementById("Explain05").innerHTML = "You are Correct! \n D. Facebook is developed by Mark Elliot Zuckerberg.";
...
function ExplainCorrect6() {
    document.getElementById("Explain06").innerHTML = "You are Correct! \n A. App development software the process of planning, designing, creating, testing, and deploying a software application to perform various business operations.";
...
function ExplainCorrect7() {
    document.getElementById("Explain07").innerHTML = "You are Correct! \n A. Tapping in a mobile handset, an app is executed by tapping.";
...
function ExplainCorrect8() {
    document.getElementById("Explain08").innerHTML = "You are Correct! \n D. Calculator is a native app and hence, it can be used offline.";
...
function ExplainCorrect9() {
    document.getElementById("Explain09").innerHTML = "You are Correct! \n A. Application the process of planning, designing, creating, testing, and deploying a software application to perform various business operations.";
...
function ExplainCorrect10() {
    document.getElementById("Explain010").innerHTML = "You are Correct! \n B. Googplay Store is the official online store for digital media distributed by Google.";
